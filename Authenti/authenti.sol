...
contract Authenti is Context, IBEP20, Ownable {
    ...
    uint256 private constant MAX = ~uint256(0);
     uint256 private _tTotal = 1000000000 * 10**12 * 10**12;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Authenti";
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        //If burnAddress has >= 250 Billion (total supply must be = 250 Billion)
        //don't take burnFee
        if(balanceOf(address(0)) < 250 * 10**9 * 10**18){
