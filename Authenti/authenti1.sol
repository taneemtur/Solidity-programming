...
contract Authenti is Context, IBEP20, Ownable {
    ...
    uint256 private constant _tTotal =  1000000000 * 10**12 * 10**12; 
    ...
    address public marketingWallet = 0x870f839206F47D2Da3f1C8a32C9cf6C58E7509c2; //test address
    uint256 private _previousmarketingFee = _marketingFee;
    
    uint256 public _maxTxAmount = 1000000 * 10**18;
    uint256 public _numTokensSellToAddToLiquidity = 2000*10**18;
    ...
    string private _name = "Authenti coin";
    ...
    function _getLPMultiplier() private view  returns (uint256) {
        if(isSale == true){
            ...
            if (time_since_start < month) {               //45% total fees
                return (6);
            } else if (time_since_start < month*2) {      //35% total fees
                return (4);
            } else if (time_since_start < month*3) {    //10% total fees
                return (2);
            } else {                            //15% total fees
                return (1);
            }
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        // add the liquidity
        pcsV2Router.addLiquidityETH{value: ethAmount}(address(this), tokenAmount, 0, 0, owner(), block.timestamp);
    }
